...
1. Behavior is preserved - Refactoring does not change what the code does, only how
2. Small steps - Make tiny changes, test after each
3. Version control is your friend - Commit before and after each safe state
4. Tests are essential - Without tests, you are not refactoring, you are editing
5. One thing at a time - Do not mix refactoring with feature changes

### When NOT to Refactor

```text
- Code that works and will not change again (if it ain't broke...)
- Critical production code without tests (add tests first)
- When you are under a tight deadline
